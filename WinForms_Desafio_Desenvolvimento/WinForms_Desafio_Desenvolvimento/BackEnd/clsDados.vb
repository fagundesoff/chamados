...
Public Class Dados
    ...
    Public Shared Function ObterChamado(ByVal idChamado As Integer) As DataRow
        ...
        Using dbConnection As New SQLiteConnection(CONNECTION_STRING)
            ...
            Using dbCommand As SQLiteCommand = dbConnection.CreateCommand()
                ...
                dbCommand.CommandText = $"SELECT ID,descricao FROM chamados WHERE ID = {idChamado}"
    ...
    Public Shared Function ObterDepartamento(ByVal idDepartament As Integer) As DataRow
        ...
        Using dbConnection As New SQLiteConnection(CONNECTION_STRING)
            ...
            Using dbCommand As SQLiteCommand = dbConnection.CreateCommand()
                ...
                dbCommand.CommandText = $"SELECT * FROM departamentos WHERE ID = {idDepartament}"

                Using dbDataAdapter As New SQLiteDataAdapter(dbCommand)

                    Dim dtDepartament As New DataTable()
                    dbDataAdapter.Fill(dtDepartament)
                    drDepartamento = dtDepartament.Rows(0)
    ...
    Public Shared Function GravaDepartamento(ByVal ID As Integer,
